...
namespace Binance
{
	...
	private:
		...
		bool IsReconnecting;
		size_t ErrorCode;
		std::weak_ptr<WebSocketClient> Socket;
		uint8_t ExponentialBackoff;
		boost::asio::io_context& IoContext;
		BinanceConfig BConfig;

	public:
		explicit ReconnectManager(std::weak_ptr<WebSocketClient> socket, boost::asio::io_context& ioContext, BinanceConfig bConfig)
